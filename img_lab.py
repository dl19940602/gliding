...
#        annotation = [bbox[0][1],bbox[0][0],bbox[1][1],bbox[1][0],bbox[2][1],bbox[2][0],bbox[3][1],bbox[3][0],'juguang', 0]
        annotation = str(bbox[0][1]) + ' ' + str(bbox[0][0]) + ' ' + str(bbox[1][1]) + ' ' + str(
            bbox[1][0]) + ' ' + str(bbox[2][1]) + ' ' + str(bbox[2][0]) + ' ' + str(bbox[3][1]) + ' ' + str(
            bbox[3][0]) + ' ' + 'juguang' + ' ' + '0'
#        annotations=annotations+annotation

        file_name = img_path.split('/')[-1].split('.')[0]+'.txt'

        Write_Text(file_name,annotation.strip(' '))
